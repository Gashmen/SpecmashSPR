...
class SMBCONNECT_SPECMASH_SERVER:
    ...
    def get_shell_csv_path(self):
        if os.getlogin() != 'Gashmen':
            ...
            self.shell_csv_path = 'D:\\Работа\\SpecmashSPR\\information_for_testing\\shell.csv'
    ...
    def get_gland_csv_path(self):
        if os.getlogin() != 'Gashmen':
            ...
            self.gland_csv_path = 'D:\\Работа\\SpecmashSPR\\information_for_testing\\Кабельные вводы ВЗОР(САПР).csv'
